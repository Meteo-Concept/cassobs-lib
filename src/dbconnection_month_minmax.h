...
class DbConnectionMonthMinmax : public DbConnectionCommon
{
	...
	private:
		...
		static constexpr char UPSERT_DATAPOINT_POSTGRESQL_STMT[] =
			...
			" SET "
			"barometer_avg=COALESCE($3, meteodata.month_minmax.barometer_avg),"
			"barometer_max=COALESCE($4, meteodata.month_minmax.barometer_max),"
			"barometer_min=COALESCE($5, meteodata.month_minmax.barometer_min),"
			"etp=COALESCE($6, meteodata.month_minmax.etp),"
			"outsidehum_max=COALESCE($7, meteodata.month_minmax.outsidehum_max),"
			"outsidehum_min=COALESCE($8, meteodata.month_minmax.outsidehum_min),"
			"outsidetemp_avg=COALESCE($9, meteodata.month_minmax.outsidetemp_avg),"
			"outsidetemp_max_max=COALESCE($10, meteodata.month_minmax.outsidetemp_max_max),"
			"outsidetemp_max_min=COALESCE($11, meteodata.month_minmax.outsidetemp_max_min),"
			"outsidetemp_min_max=COALESCE($12, meteodata.month_minmax.outsidetemp_min_max),"
			"outsidetemp_min_min=COALESCE($13, meteodata.month_minmax.outsidetemp_min_min),"
			"rainfall=COALESCE($14, meteodata.month_minmax.rainfall),"
			"rainfall_max=COALESCE($15, meteodata.month_minmax.rainfall_max),"
			"rainrate_max=COALESCE($16, meteodata.month_minmax.rainrate_max),"
			"solarrad_avg=COALESCE($17, meteodata.month_minmax.solarrad_avg),"
			"solarrad_max=COALESCE($18, meteodata.month_minmax.solarrad_max),"
			"uv_max=COALESCE($19, meteodata.month_minmax.uv_max),"
			"winddir=COALESCE($20, meteodata.month_minmax.winddir),"
			"wind_speed_avg=COALESCE($21, meteodata.month_minmax.wind_speed_avg),"
			"windgust_speed_max=COALESCE($22, meteodata.month_minmax.windgust_speed_max),"
			"insolation_time=COALESCE($23, meteodata.month_minmax.insolation_time),"
			"insolation_time_max=COALESCE($24, meteodata.month_minmax.insolation_time_max),"
			"diff_outside_temperature_avg=COALESCE($25, meteodata.month_minmax.diff_outside_temperature_avg),"
			"diff_outside_temperature_min_min=COALESCE($26, meteodata.month_minmax.diff_outside_temperature_min_min),"
			"diff_outside_temperature_max_max=COALESCE($27, meteodata.month_minmax.diff_outside_temperature_max_max),"
			"diff_rainfall=COALESCE($28, meteodata.month_minmax.diff_rainfall),"
			"diff_insolation_time=COALESCE($29, meteodata.month_minmax.diff_insolation_time) "
		;

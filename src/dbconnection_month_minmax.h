...
class DbConnectionMonthMinmax : public DbConnectionCommon
{
	...
	private:
		...
		static constexpr char UPSERT_DATAPOINT_POSTGRESQL_STMT[] =
			...
			" SET "
			"barometer_avg=COALESCE($3, barometer_avg),"
			"barometer_max=COALESCE($4, barometer_max),"
			"barometer_min=COALESCE($5, barometer_min),"
			"etp=COALESCE($6, etp),"
			"outsidehum_max=COALESCE($7, outsidehum_max),"
			"outsidehum_min=COALESCE($8, outsidehum_min),"
			"outsidetemp_avg=COALESCE($9, outsidetemp_avg),"
			"outsidetemp_max_max=COALESCE($10, outsidetemp_max_max),"
			"outsidetemp_max_min=COALESCE($11, outsidetemp_max_min),"
			"outsidetemp_min_max=COALESCE($12, outsidetemp_min_max),"
			"outsidetemp_min_min=COALESCE($13, outsidetemp_min_min),"
			"rainfall=COALESCE($14, rainfall),"
			"rainfall_max=COALESCE($15, rainfall_max),"
			"rainrate_max=COALESCE($16, rainrate_max),"
			"solarrad_avg=COALESCE($17, solarrad_avg),"
			"solarrad_max=COALESCE($18, solarrad_max),"
			"uv_max=COALESCE($19, uv_max),"
			"winddir=COALESCE($20, winddir),"
			"wind_speed_avg=COALESCE($21, wind_speed_avg),"
			"windgust_speed_max=COALESCE($22, windgust_speed_max),"
			"insolation_time=COALESCE($23, insolation_time),"
			"insolation_time_max=COALESCE($24, insolation_time_max),"
			"diff_outside_temperature_avg=COALESCE($25, diff_outside_temperature_avg),"
			"diff_outside_temperature_min_min=COALESCE($26, diff_outside_temperature_min_min),"
			"diff_outside_temperature_max_max=COALESCE($27, diff_outside_temperature_max_max),"
			"diff_rainfall=COALESCE($28, diff_rainfall),"
			"diff_insolation_time=COALESCE($29, diff_insolation_time) "
		;

...
private:
	...
	static constexpr char UPSERT_DATAPOINT_POSTGRESQL_STMT[] =
		...
		"SET "
		"barometer_min=COALESCE($3, meteodata.minmax.barometer_min),"
		"barometer_max=COALESCE($4, meteodata.minmax.barometer_max),"
		"barometer_avg=COALESCE($5, meteodata.minmax.barometer_avg),"
		"dayet=COALESCE($6, meteodata.minmax.dayet),"
		"monthet=COALESCE($7, meteodata.minmax.monthet),"
		"yearet=COALESCE($8, meteodata.minmax.yearet),"
		"dayrain=COALESCE($9, meteodata.minmax.dayrain),"
		"monthrain=COALESCE($10, meteodata.minmax.monthrain),"
		"yearrain=COALESCE($11, meteodata.minmax.yearrain),"
		"dewpoint_max=COALESCE($12, meteodata.minmax.dewpoint_max),"
		"dewpoint_avg=COALESCE($13, meteodata.minmax.dewpoint_avg),"
		"insidehum_min=COALESCE($14, meteodata.minmax.insidehum_min),"
		"insidehum_max=COALESCE($15, meteodata.minmax.insidehum_max),"
		"insidehum_avg=COALESCE($16, meteodata.minmax.insidehum_avg),"
		"insidetemp_min=COALESCE($17, meteodata.minmax.insidetemp_min),"
		"insidetemp_max=COALESCE($18, meteodata.minmax.insidetemp_max),"
		"insidetemp_avg=COALESCE($19, meteodata.minmax.insidetemp_avg),"
		"leaftemp1_min=COALESCE($20, meteodata.minmax.leaftemp1_min),"
		"leaftemp1_max=COALESCE($21, meteodata.minmax.leaftemp1_max),"
		"leaftemp1_avg=COALESCE($22, meteodata.minmax.leaftemp1_avg),"
		"leaftemp2_min=COALESCE($23, meteodata.minmax.leaftemp2_min),"
		"leaftemp2_max=COALESCE($24, meteodata.minmax.leaftemp2_max),"
		"leaftemp2_avg=COALESCE($25, meteodata.minmax.leaftemp2_avg),"
		"leafwetnesses1_min=COALESCE($26, meteodata.minmax.leafwetnesses1_min),"
		"leafwetnesses1_max=COALESCE($27, meteodata.minmax.leafwetnesses1_max),"
		"leafwetnesses1_avg=COALESCE($28, meteodata.minmax.leafwetnesses1_avg),"
		"leafwetnesses2_min=COALESCE($29, meteodata.minmax.leafwetnesses2_min),"
		"leafwetnesses2_max=COALESCE($30, meteodata.minmax.leafwetnesses2_max),"
		"leafwetnesses2_avg=COALESCE($31, meteodata.minmax.leafwetnesses2_avg),"
		"outsidehum_min=COALESCE($32, meteodata.minmax.outsidehum_min),"
		"outsidehum_max=COALESCE($33, meteodata.minmax.outsidehum_max),"
		"outsidehum_avg=COALESCE($34, meteodata.minmax.outsidehum_avg),"
		"outsidetemp_min=COALESCE($35, meteodata.minmax.outsidetemp_min),"
		"outsidetemp_max=COALESCE($36, meteodata.minmax.outsidetemp_max),"
		"outsidetemp_avg=COALESCE($37, meteodata.minmax.outsidetemp_avg),"
		"rainrate_max=COALESCE($38, meteodata.minmax.rainrate_max),"
		"soilmoistures1_min=COALESCE($39, meteodata.minmax.soilmoistures1_min),"
		"soilmoistures1_max=COALESCE($40, meteodata.minmax.soilmoistures1_max),"
		"soilmoistures1_avg=COALESCE($41, meteodata.minmax.soilmoistures1_avg),"
		"soilmoistures2_min=COALESCE($42, meteodata.minmax.soilmoistures2_min),"
		"soilmoistures2_max=COALESCE($43, meteodata.minmax.soilmoistures2_max),"
		"soilmoistures2_avg=COALESCE($44, meteodata.minmax.soilmoistures2_avg),"
		"soilmoistures3_min=COALESCE($45, meteodata.minmax.soilmoistures3_min),"
		"soilmoistures3_max=COALESCE($46, meteodata.minmax.soilmoistures3_max),"
		"soilmoistures3_avg=COALESCE($47, meteodata.minmax.soilmoistures3_avg),"
		"soilmoistures4_min=COALESCE($48, meteodata.minmax.soilmoistures4_min),"
		"soilmoistures4_max=COALESCE($49, meteodata.minmax.soilmoistures4_max),"
		"soilmoistures4_avg=COALESCE($50, meteodata.minmax.soilmoistures4_avg),"
		"soiltemp1_min=COALESCE($51, meteodata.minmax.soiltemp1_min),"
		"soiltemp1_max=COALESCE($52, meteodata.minmax.soiltemp1_max),"
		"soiltemp1_avg=COALESCE($53, meteodata.minmax.soiltemp1_avg),"
		"soiltemp2_min=COALESCE($54, meteodata.minmax.soiltemp2_min),"
		"soiltemp2_max=COALESCE($55, meteodata.minmax.soiltemp2_max),"
		"soiltemp2_avg=COALESCE($56, meteodata.minmax.soiltemp2_avg),"
		"soiltemp3_min=COALESCE($57, meteodata.minmax.soiltemp3_min),"
		"soiltemp3_max=COALESCE($58, meteodata.minmax.soiltemp3_max),"
		"soiltemp3_avg=COALESCE($59, meteodata.minmax.soiltemp3_avg),"
		"soiltemp4_min=COALESCE($60, meteodata.minmax.soiltemp4_min),"
		"soiltemp4_max=COALESCE($61, meteodata.minmax.soiltemp4_max),"
		"soiltemp4_avg=COALESCE($62, meteodata.minmax.soiltemp4_avg),"
		"extratemp1_min=COALESCE($63, meteodata.minmax.extratemp1_min),"
		"extratemp1_max=COALESCE($64, meteodata.minmax.extratemp1_max),"
		"extratemp1_avg=COALESCE($65, meteodata.minmax.extratemp1_avg),"
		"extratemp2_min=COALESCE($66, meteodata.minmax.extratemp2_min),"
		"extratemp2_max=COALESCE($67, meteodata.minmax.extratemp2_max),"
		"extratemp2_avg=COALESCE($68, meteodata.minmax.extratemp2_avg),"
		"extratemp3_min=COALESCE($69, meteodata.minmax.extratemp3_min),"
		"extratemp3_max=COALESCE($70, meteodata.minmax.extratemp3_max),"
		"extratemp3_avg=COALESCE($71, meteodata.minmax.extratemp3_avg),"
		"extrahum1_min=COALESCE($72, meteodata.minmax.extrahum1_min),"
		"extrahum1_max=COALESCE($73, meteodata.minmax.extrahum1_max),"
		"extrahum1_avg=COALESCE($74, meteodata.minmax.extrahum1_avg),"
		"extrahum2_min=COALESCE($75, meteodata.minmax.extrahum2_min),"
		"extrahum2_max=COALESCE($76, meteodata.minmax.extrahum2_max),"
		"extrahum2_avg=COALESCE($77, meteodata.minmax.extrahum2_avg),"
		"solarrad_max=COALESCE($78, meteodata.minmax.solarrad_max),"
		"solarrad_avg=COALESCE($79, meteodata.minmax.solarrad_avg),"
		"uv_max=COALESCE($80, meteodata.minmax.uv_max),"
		"uv_avg=COALESCE($81, meteodata.minmax.uv_avg),"
		"winddir=COALESCE($82, meteodata.minmax.winddir),"
		"windgust_max=COALESCE($83, meteodata.minmax.windgust_max),"
		"windgust_avg=COALESCE($84, meteodata.minmax.windgust_avg),"
		"windspeed_max=COALESCE($85, meteodata.minmax.windspeed_max),"
		"windspeed_avg=COALESCE($86, meteodata.minmax.windspeed_avg),"
		"insolation_time=COALESCE($87, meteodata.minmax.insolation_time)"
	;
